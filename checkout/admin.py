...
class ProductOrderAdmin(admin.ModelAdmin):
    ...
    search_fields = ("id", "user__username", "receiver_name", "receiver_phone", "address_line1", "city", "province")
    readonly_fields = (
        "user","cart","receiver_name","receiver_phone","address_line1","address_line2","city",
        "province","postal_code","country","subtotal","shipping_fee","total","notes","created_at"
    )
    ordering = ("-created_at",)
